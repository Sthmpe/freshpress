...
class FreshPressCircularLoader extends StatelessWidget {
  ...
  const FreshPressCircularLoader({
    super.key,
    this.foregroundColor = FreshPressAppColors.white,
    this.backgroundColor = FreshPressAppColors.primary,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(FreshPressSizes.lg),
