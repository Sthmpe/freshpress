...
class FreshPressFirebaseAuthException implements Exception {
  /// The error code associated with the exception.
  final String code;

  /// Constructor that takes an error code.
  FreshPressFirebaseAuthException(this.code);
  ...
  String get message {
    switch (code) {
      ...
      // Removed duplicate 'user-not-found' case
      ...
      // Removed duplicate 'user-disabled' case
