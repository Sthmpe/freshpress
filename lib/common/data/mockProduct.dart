...
final List<ProductModel> mockProducts = [
  ProductModel(
    ...
    price: 700.00,
    quantity: 10,
    imagePath: FreshPressImages.productImage1,
  ),
  ProductModel(
    id: 'FreshPress_2',
    name: 'M4 Macbook Air 13/" 256GB',
    description: 'This pre-owned product is not Apple certified, but has been professionally inspected, tested and cleaned by Amazon-qualified suppliers.\nThere will be no visible cosmetic imperfections when held at an arm’s length.\nThis product will have a battery which exceeds 80% capacity relative to new.\nAccessories will not be original, but will be compatible and fully functional. Product may come in generic Box.\nThis product is eligible for a replacement or refund within 90 days of receipt if you are not satisfied.',
    color: 'Sky blue',
    price: 1000.00,
    quantity: 3,
    imagePath: FreshPressImages.productImage2,
  ),
  ProductModel(
    id: 'FreshPress_3',
    ...
    price: 499.00,
    quantity: 2,
    imagePath: FreshPressImages.productImage3,
  ),
  ProductModel(
    id: 'FreshPress_4',
    ...
    price: 129.00,
    quantity: 2,
    imagePath: FreshPressImages.productImage4,
  ),
  ProductModel(
    id: 'FreshPress_5',
    name: 'Apple iPhone 16 128GB',
    ...
    imagePath:
        FreshPressImages
            .productImage1, // Assuming you have a constant for the image path
  ),
  ProductModel(
    id: 'FreshPress_6',
    name: 'M4 Macbook Air 13/" 256GB',
